...
import p09_customListIterator.model.impl.MyListImpl;
import p09_customListIterator.model.impl.SortMyList;
    ...
    private static void commandDispatcher(String[] tokens, MyList<String> myList) {
        ...
        switch (command) {
            ...
            case "Min":
                ...
                break;
            case "Print":
                myList.getCollection().forEachRemaining(System.out::println);
                break;
            case "Sort":
